    ...
    <section id="contact" className="py-24 bg-surface relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 lg:px-8 text-center">
        ...
        <ScrollReveal delay={0.1}>
          <h2 className="text-3xl md:text-[40px] font-bold text-[#f0f0f5] tracking-tight leading-tight">
            Un projet en tête ?
          </h2>
        </ScrollReveal>

        <ScrollReveal delay={0.2}>
          <p className="mt-4 font-mono text-[13px] text-white/30 tracking-wide">
            Discutons-en.
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.4}>
          <div className="mt-10 flex items-center justify-center gap-4">
            <a
              ...
              className="w-11 h-11 rounded-full flex items-center justify-center text-white/40 hover:text-brand transition-all duration-300 hover:shadow-[0_0_20px_rgba(147,51,234,0.2)]"
              style={{
